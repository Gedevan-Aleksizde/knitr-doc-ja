...
![knitr 上の tikz グラフィックス](https://db.yihui.org/imgur/HCkka.png)

![knitr 上の ggplot2](https://db.yihui.org/imgur/BTEiu.png)
...
````r
`r ''````{r dev='pdf', dev.args=list(pointsize=10)}
plot(rnorm(100))
```
````
