...
**ちょっと待った**, 上記のコードをコピペしないでください. これはすでに少々の機能を追加した上で `render_listings()` 関数として **`knitr`** に組み込まれています. これが使用例になります.
...
knitr::include_graphics("https://db.yihui.org/imgur/PKupQ.png")
```
...
knitr::include_graphics("https://db.yihui.org/imgur/3313T.png")
```
