...
出力ファイルタイプが LaTeX の場合, デフォルトのフックはほとんどのチャンク出力を `verbatim` 環境で囲んで出力し, `inline` 出力における数値を指数表記で出力します (詳細は see [output demo](../demo/output/) を参照してください). `plot`, `chunk` フックはより複雑な処理をしています.
